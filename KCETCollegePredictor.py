...
df = pd.read_csv("https://github.com/VishnuSastryHK/KCETCollegePredictor/blob/master/CET_Database_Final2019.csv",delimiter=",",encoding='utf-8', index_col=0) #names=col_names)
