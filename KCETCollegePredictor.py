...
df = pd.read_csv("https://github.com/VishnuSastryHK/KCETCollegePredictor/blob/master/CET_Database_Final2019.csv",delimiter=",", encoding='latin1',engine='python')#encoding='utf-8' encoding='latin1',engine='python') #names=col_names)
