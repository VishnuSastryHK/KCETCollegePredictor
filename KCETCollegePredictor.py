...
df = pd.read_csv("https://github.com/VishnuSastryHK/KCETCollegePredictor/blob/master/CET_Database_Final2019.xlsx", sep="\s+|;|:")#sep=r'\s*,\s*')#, error_bad_lines=False)# names=col_names)
