...
df = pd.read_csv("https://github.com/VishnuSastryHK/KCETCollegePredictor/blob/master/CET_Database_Final2019.csv", index_col=False, encoding='iso-8859-1', 
                        warn_bad_lines=True, error_bad_lines=False)#names=col_names,)
