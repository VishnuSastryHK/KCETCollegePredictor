...
df = pd.read_csv("https://github.com/VishnuSastryHK/KCETCollegePredictor/blob/master/CET_Database_Final2019.csv",delimiter=",",error_bad_lines=False) #names=col_names)
